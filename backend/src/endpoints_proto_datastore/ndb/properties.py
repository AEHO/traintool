...
class EndpointsDateTimeProperty(ndb.DateTimeProperty):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        self._string_format = kwargs.pop(
            'string_format', DATETIME_STRING_FORMAT)
...
class EndpointsVariantIntegerProperty(ndb.IntegerProperty):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        # The value of variant will be verified when the message field is
        # created
        self._variant = kwargs.pop(
...
class EndpointsComputedProperty(ndb.ComputedProperty):
    ...
    def __call__(self, func):
        ...
        super(EndpointsComputedProperty, self).__init__(
            func, **self.__saved_kwargs)
    ...
    def _set_value(self, unused_entity, unused_value):
        ...
        """
        warnings.warn('Cannot assign to a ComputedProperty.',
                      DeprecationWarning)
